                    ...
                    <div class="vdatetime-popup__body" ref="popupBody">
                        <div v-show="show === 'date'">
                            ...
                            <div class="vdatetime-popup__date-picker" :style="{height: datePickerHeight}">
                                <div class="vdatetime-popup__date-picker__item vdatetime-popup__date-picker__item--header"
                                     v-for="weekday in weekdays">{{ weekday }}
                                </div>
                                <div class="vdatetime-popup__date-picker__item" v-for="day in currentMonthDays"
                                     @click="!day.disabled && selectDay(day.number)"
                                     :class="{'vdatetime-popup__date-picker__item--selected': day.selected, 'vdatetime-popup__date-picker__item--disabled': day.disabled}">
                                    <span><span>{{ day.number }}</span></span>
                                </div>
                            </div>
                        </div>
                        <div v-show="show === 'time'" class="vdatetime-popup__list-picker-wrapper">
                            <div class="vdatetime-popup__list-picker vdatetime-popup__list-picker--half"
                                 ref="hourPicker">
                                <div class="vdatetime-popup__list-picker__item" v-for="hour in hours"
                                     @click="selectHour(hour.number)"
                                     :class="{'vdatetime-popup__list-picker__item--selected': hour.selected}">{{
                                    hour.number }}
                                </div>
                            </div>
                            <div class="vdatetime-popup__list-picker vdatetime-popup__list-picker--half"
                                 ref="minutePicker">
                                <div class="vdatetime-popup__list-picker__item" v-for="minute in minutes"
                                     @click="selectMinute(minute.number)"
                                     :class="{'vdatetime-popup__list-picker__item--selected': minute.selected}">{{
                                    minute.number }}
                                </div>
                            </div>
                        </div>
                        <div v-show="show === 'year'" class="vdatetime-popup__list-picker-wrapper">
                            <div class="vdatetime-popup__list-picker" ref="yearPicker">
                                <div class="vdatetime-popup__list-picker__item" v-for="year in years"
                                     @click="selectYear(year.number)"
                                     :class="{'vdatetime-popup__list-picker__item--selected': year.selected}">{{
                                    year.number }}
                                </div>
                            </div>
                        </div>
